...
|---|---:|---:|---:|---:|---:|---:|
| 批量插入 1 万 | **146.70 µs** | 242.59 µs | 287.62 µs | 273.84 µs† | 261.05 µs | 157.98 µs |
| 遍历 1 万 | **4.96 µs** | 5.10 µs | 7.69 µs | 5.15 µs | 7.78 µs | 11.03 µs |
...
† Flecs 批量插入来自一次修正后的定向测试，不属于已归档的六轮中位数；具体边界见性能测试文档。
