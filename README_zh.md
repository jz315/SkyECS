...
| 场景 | Sky | 最接近或更快的对手 |
|---|---:|---:|
| 批量插入 1 万 | **146.7 µs** | Shipyard 158.0 µs |
| 遍历 1 万 | **4.96 µs** | hecs 5.10 µs |
| 遍历 10 万 | **52.31 µs** | **Flecs 52.01 µs** |
| Spawn/despawn 1 千 | **19.57 µs** | hecs 24.51 µs |
| 混合帧 | **181.68 µs** | hecs 195.09 µs |
