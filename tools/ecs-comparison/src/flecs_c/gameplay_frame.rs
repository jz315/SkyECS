...
fn native_digest(native: NativeGameplayDigest) -> GameplayDigest {
    GameplayDigest {
        ...
        velocity_checksum: native.velocity_checksum,
        health_checksum: native.health_checksum,
        damage_checksum: native.damage_checksum,
        regen_checksum: native.regen_checksum,
        cooldown_checksum: native.cooldown_checksum,
